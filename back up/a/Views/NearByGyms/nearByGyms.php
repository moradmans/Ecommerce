...
<?php include 'header.php'; ?>
    ...
    <?php if ($isAdminOrStaff) : ?>
        ...
        <div id="deleteGymForm">
        <h2>Delete a Gym</h2>
        <form action="index.php?controller=nearByGyms&action=delete" method="post" onsubmit="deleteGym(event)">
            <label for="deleteGym">Gym Address to Delete:</label>
            <input type="text" id="deleteGym" name="address" required>
            <button type="submit" name="deleteGym">Delete Gym</button>
        </form>
    </div>
    <?php endif; ?>
