...
<section class="content">
    ...
    <div id="gymForm">
        <h2>Add a New Supplement</h2>
        <form action="index.php?controller=supplement&action=add" method="post" onsubmit="addSupplement(event)">
            <label for="Name">Name of the Supplement:</label>
            <input type="text" id="Name" name="Name" required>

            <label for="Price">Supplement Price:</label>
            ...
            <button type="submit" name="addSupplement">Add Supplement</button>
        </form>
    </div>
<?php endif; ?>
<?php if ($isAdminOrStaff) : ?>
    <div id="gymForm">
        <h2>Delete a Supplement</h2>
        <form action="index.php?controller=supplement&action=del" method="post" onsubmit="delSupplement(event)">
            <label for="Name">Name of the product:</label>
            <input type="text" id="Name" name="Name" required>

            <button type="submit" name="delSupplement">Delete Supplement</button>
        </form>
    </div>
<?php endif; ?>
